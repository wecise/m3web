...
var _sumByWindow = 0;
var _w = odb.mql("select count(*) from /matrix/entity/window limit -1");
if(_w){
    _sumByWindow = _w[0].count;
}

var _sumByUnix = 0;
var _u = odb.mql("select count(*) from /matrix/entity/unix limit -1");
if(_u){
...
var _hostList = {
    ...
    columns: [
        ...
        {"data":"host","title":"服务器名称","visible":true, className: 'text-right'},
