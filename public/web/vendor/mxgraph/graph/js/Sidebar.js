...
Sidebar.prototype.addSvgPalette = function(id, title, prefix, postfix, items, titles, tags)
{
	...
	for (var i = 0; i < items.length; i++)
	{
		(mxUtils.bind(this, function(item, title, tmpTags)
		{
			...
			fns.push(this.createVertexTemplateEntry('image;html=1;labelBackgroundColor=transparent;image=' + prefix + item + postfix,
...
Sidebar.prototype.addBpmnPalette = function(dir, expand)
{
	...
	[
		...
		this.createVertexTemplateEntry('swimlane;html=1;horizontal=0;startSize=20;', 320, 320, 'Pool', 'Pool', null, null, 'bpmn pool'),
	...
	this.addPaletteFunctions('bpmn', '流程建模', false, fns);
