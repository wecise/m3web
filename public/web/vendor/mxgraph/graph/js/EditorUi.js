 ...
 */
EditorUi.prototype.menubarHeight = 0;//30;
...
EditorUi.prototype.createUi = function()
{
	...
	{	
		var menu = `<div role="tabpanel" id="imap-tabs">
						<ul class="nav nav-tabs" role="tablist" style="border: none;border-bottom: 1px solid #efefef;">
							...
							<li role="presentation" class="">
								<a href="#imap-shape" aria-controls="imap-shape" role="tab" data-toggle="tab" aria-expanded="false"><i class="fa fa-cube"></i> `+mxResources.get('mx-menu-shape')+`</a>
							</li>
						</ul>
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane active" id="imap-config"></div>
