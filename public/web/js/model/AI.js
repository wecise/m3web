                                        ...
                                        <el-main style="padding:0px;">
                                            <el-tabs v-model="main.activeIndex" type="border-card" closable @tab-remove="close">
                                                <el-tab-pane :label="tab.name" :key="tab.id" :name="tab.id" v-for="tab in main.tabs">
                                                    ...
                                                    <matrix-ai-setup-relation :id="tab.component+'-'+tab.id" :model="tab" v-if="tab.component=='relation'" transition="fade" transition-mode="out-in"></matrix-ai-setup-relation>
                                                </el-tab-pane>
                                            </el-tabs>
                                        </el-main>
                                    </el-container>
