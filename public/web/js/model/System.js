										...
										<el-container style="height:100%;">
											<el-main style="overflow:hidden;padding:0px 10px;">
												<el-form ref="form" :model="dialog.edit.data" label-width="80px" v-if="dialog.edit.data">
													...
													<el-form-item label="类规则">
														<el-input v-model="dialog.edit.data.class_rule" placeholder="选择类"
															clearable
															autofocus>
															<template slot="prepend">
																<el-dropdown trigger="hover" placement="top-end"  :hide-on-click="true">
																	...
																	<el-dropdown-menu slot="dropdown">
																		<el-dropdown-item>
																			<template scope="scope">
																				<mx-entity-tree root="/matrix" :filterEnable="false" ref="entityTree" @node-click="(data)=>{ dialog.edit.data.class_rule = data.class; }"></mx-entity-tree>
																			</template>
																		</el-dropdown-item>
																	</el-dropdown-menu>
																</el-dropdown>
